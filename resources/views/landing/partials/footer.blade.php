    ...
    <div class="container py-4 py-lg-5">
        <div class="row justify-content-center px-3">
            <div
                ...
                <p class="text-white">Website Resmi Kebun Lebar, Kecamatan Pematang Tiga, Kabupaten Bengkulu Tengah
                    berfungsi sebagai pusat informasi, transparansi dan sosialisasi pemerintah bagi masyarakat selaku
                    penerima manfaat.</p>
            </div>
            <div class="col-sm-4-text-center  col-md-3 text-lg-start d-flex flex-column">
                ...
                <ul class="list-unstyled">
                    <li data-bss-hover-animate="pulse">
                        <a class="navbar-brand" href="https://bengkulutengahkab.go.id/">
                            ...
                            </svg>Website Kabupaten Bengkulu Tengah</a>
                    </li>
                </ul>
            </div>
            <div class="col-sm-4-text-center col-md-3 text-lg-start d-flex flex-column">
                ...
                <ul class="list-unstyled">
                    <li>Pemerintahan Desa Kebun Lebar</li>
                    <li>E-Mail: diklat.bankbengkulu@gmail.com</li>
                    <li>Nomor Telp: 1500133 (24 Jam)</li>
                </ul>
            </div>
        ...
        <div class="d-flex justify-content-between align-items-center pt-3">
            <p class="mb-0">Copyright © 2023 Pemerintahan Desa Kebun Lebar | Universitas
                Bengkulu</p>
        </div>
    </div>
</footer>
